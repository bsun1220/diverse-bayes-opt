...
class Branin2DSimulator(Simulator):
    def __init__(self, uid : str = ''):
        ...
        self.true_max = -0.397887
        self.Branin = Branin(negate = True)
...
class Griewank2DSimulator(Simulator):
    def __init__(self, uid : str = ''):
        ...
        super().__init__(2, uid, bounds)
        self.true_max = 0
        self.Griewank = Griewank(negate = True)
...
class SixHumpCamel2DSimulator(Simulator):
    def __init__(self, uid : str = ''):
        ...
        super().__init__(2, uid, bounds)
        self.true_max = 1.0316
        self.SixHumpCamel = SixHumpCamel(negate = True)
...
class HolderTable2DSimulator(Simulator):
    def __init__(self, uid : str = ''):
        ...
        super().__init__(2, uid, bounds)
        self.true_max = 19.2
        self.HolderTable = HolderTable(negate = True)
